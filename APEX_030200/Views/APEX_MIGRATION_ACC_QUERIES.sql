CREATE OR REPLACE FORCE VIEW apex_migration_acc_queries (project_id,project_name,migration_type,dbid,query_id,query_type,query_name,query_sql,created_on,created_by,last_updated_on,last_updated_by,"SCHEMA",workspace,workspace_id) AS
select
