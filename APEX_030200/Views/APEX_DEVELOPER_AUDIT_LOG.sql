CREATE OR REPLACE FORCE VIEW apex_developer_audit_log (application_id,developer,audit_date,"UPDATED",audit_action,page_id,page_name,"COMPONENT",component_name,security_group_id,flow_table_pk) AS
select
