CREATE TABLE wwv_mig_olb_t_tp_gg_graphics (
  ...
  CONSTRAINT wwv_mig_olb_t_tp_gg_graphcs_pk PRIMARY KEY ("ID") USING INDEX NOCOMPRESS
    PCTFREE 10 INITRANS 2 LOGGING
    STORAGE(FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
    TABLESPACE "SYSAUX",
  CONSTRAINT wwv_mig_olb_t_tp_ggg_g_id_fk FOREIGN KEY (graphics_id) REFERENCES wwv_mig_olb_t_tp_g_graphics ("ID") ON DELETE CASCADE,
  CONSTRAINT wwv_mig_olb_t_tp_ggg_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE
) NOCOMPRESS
