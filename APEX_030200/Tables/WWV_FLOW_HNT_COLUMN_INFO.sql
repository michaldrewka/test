CREATE TABLE wwv_flow_hnt_column_info (
  ...
  CONSTRAINT wwv_flow_hnt_column_info_pk PRIMARY KEY (column_id) USING INDEX NOCOMPRESS
    PCTFREE 10 INITRANS 2 LOGGING
    STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
    FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
    TABLESPACE "SYSAUX",
  CONSTRAINT wwv_flow_hnt_column_info_uk UNIQUE (table_id,column_name) USING INDEX NOCOMPRESS
    PCTFREE 10 INITRANS 2 LOGGING
    STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
    FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
    TABLESPACE "SYSAUX",
  CONSTRAINT wwv_flow_hnt_col_info_tab_fk FOREIGN KEY (table_id) REFERENCES wwv_flow_hnt_table_info (table_id) ON DELETE CASCADE
) NOCOMPRESS
