CREATE TABLE wwv_flow_model_page_cols (
  ...
  CONSTRAINT wwv_flow_model_page_cols_pk PRIMARY KEY ("ID") USING INDEX NOCOMPRESS
    PCTFREE 10 INITRANS 2 LOGGING
    STORAGE(FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
    TABLESPACE "SYSAUX",
  CONSTRAINT wwv_flow_model_page_cols_fk FOREIGN KEY (model_region_id) REFERENCES wwv_flow_model_page_regions ("ID") ON DELETE CASCADE
) NOCOMPRESS
