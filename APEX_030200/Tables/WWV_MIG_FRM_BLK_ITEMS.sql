CREATE TABLE wwv_mig_frm_blk_items (
  ...
  databaseitem VARCHAR2(4000 BYTE) DEFAULT 'true',
  justification VARCHAR2(4000 BYTE),
  "REQUIRED" VARCHAR2(4000 BYTE) DEFAULT 'false',
  ...
  mousenavigate VARCHAR2(4000 BYTE) DEFAULT 'true',
  keyboardnavigable VARCHAR2(4000 BYTE) DEFAULT 'true',
  ...
  showpalette VARCHAR2(4000 BYTE),
  select_for_app VARCHAR2(1 BYTE) DEFAULT 'Y' NOT NULL CONSTRAINT wwv_mig_frm_bi_sel_for_app CHECK (select_for_app in ('Y', 'N')),
  ...
  CONSTRAINT wwv_mig_frm_blk_items_pk PRIMARY KEY ("ID") USING INDEX NOCOMPRESS
    PCTFREE 10 INITRANS 2 LOGGING
    STORAGE(FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
    TABLESPACE "SYSAUX",
  CONSTRAINT wwv_mig_frm_bi_blk_id_fk FOREIGN KEY (block_id) REFERENCES wwv_mig_frm_blocks ("ID") ON DELETE CASCADE,
  CONSTRAINT wwv_mig_frm_bi_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE
) NOCOMPRESS
