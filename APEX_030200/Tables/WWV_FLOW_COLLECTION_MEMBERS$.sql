CREATE TABLE wwv_flow_collection_members$ (
  ...
  CONSTRAINT wwv_flow_collection_members_pk PRIMARY KEY (collection_id,seq_id,security_group_id) USING INDEX NOCOMPRESS
    PCTFREE 10 INITRANS 2 LOGGING
    STORAGE(FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
    TABLESPACE "SYSAUX",
  CONSTRAINT wwv_flow_collection_membes_fk FOREIGN KEY (collection_id) REFERENCES wwv_flow_collections$ ("ID") ON DELETE CASCADE
) NOCOMPRESS
