CREATE TABLE wwv_mig_acc_rpts_controls (
  ...
  CONSTRAINT wwv_flow_rep_ctl_pk PRIMARY KEY ("ID") USING INDEX NOCOMPRESS
    PCTFREE 10 INITRANS 2 LOGGING
    STORAGE(FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
    TABLESPACE "SYSAUX",
  CONSTRAINT wwv_mig_acc_rep_ctl_fk FOREIGN KEY (project_id,dbid,reportid) REFERENCES wwv_mig_acc_reports (project_id,dbid,reportid) ON DELETE CASCADE
) NOCOMPRESS
