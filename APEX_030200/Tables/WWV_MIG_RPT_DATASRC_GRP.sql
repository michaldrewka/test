CREATE TABLE wwv_mig_rpt_datasrc_grp (
  ...
  CONSTRAINT wwv_mig_grp_pk PRIMARY KEY ("ID") USING INDEX NOCOMPRESS
    PCTFREE 10 INITRANS 2 LOGGING
    STORAGE(FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
    TABLESPACE "SYSAUX",
  CONSTRAINT wwv_mig_grp_id_fk FOREIGN KEY (datasrc_id) REFERENCES wwv_mig_rpt_datasrc ("ID") ON DELETE CASCADE,
  CONSTRAINT wwv_mig_grp_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE
) NOCOMPRESS
PCTFREE 10 INITRANS 1 LOGGING
STORAGE(FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
TABLESPACE "SYSAUX"
LOB (formattrigger) STORE AS BASICFILE (
