CREATE TABLE wwv_mig_acc_forms_controls (
  ...
  CONSTRAINT wwv_mig_frms_ctl_pk PRIMARY KEY ("ID") USING INDEX NOCOMPRESS
    PCTFREE 10 INITRANS 2 LOGGING
    STORAGE(FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
    TABLESPACE "SYSAUX",
  CONSTRAINT wwv_mig_acc_frm_ctl_fk FOREIGN KEY (project_id,dbid,formid) REFERENCES wwv_mig_acc_forms (project_id,dbid,formid) ON DELETE CASCADE
) NOCOMPRESS
