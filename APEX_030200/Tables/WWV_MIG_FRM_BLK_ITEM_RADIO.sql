CREATE TABLE wwv_mig_frm_blk_item_radio (
  ...
  CONSTRAINT wwv_mig_frm_blk_item_radio_pk PRIMARY KEY ("ID") USING INDEX NOCOMPRESS
    PCTFREE 10 INITRANS 2 LOGGING
    STORAGE(FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
    TABLESPACE "SYSAUX",
  CONSTRAINT wwv_mig_frm_bir_item_id_fk FOREIGN KEY (item_id) REFERENCES wwv_mig_frm_blk_items ("ID") ON DELETE CASCADE,
  CONSTRAINT wwv_mig_frm_bir_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE
) NOCOMPRESS
PCTFREE 10 INITRANS 1 LOGGING
STORAGE(FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
TABLESPACE "SYSAUX"
LOB (radiobutton_comment) STORE AS BASICFILE (
