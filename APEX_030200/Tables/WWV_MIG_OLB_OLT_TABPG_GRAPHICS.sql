CREATE TABLE wwv_mig_olb_olt_tabpg_graphics (
  ...
  select_for_app VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL CONSTRAINT wwv_mig_olb_olt_tpg_sel_f_app CHECK (select_for_app in ('Y', 'N')),
  ...
  CONSTRAINT wwv_mig_olb_olt_tabpg_grphs_pk PRIMARY KEY ("ID") USING INDEX NOCOMPRESS
    PCTFREE 10 INITRANS 2 LOGGING
    STORAGE(FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
    TABLESPACE "SYSAUX",
  CONSTRAINT wwv_mig_olb_olt_tpg_sg_id_fk FOREIGN KEY (security_group_id) REFERENCES wwv_flow_companies (provisioning_company_id) ON DELETE CASCADE,
  CONSTRAINT wwv_mig_olb_olt_tpg_tp_id_fk FOREIGN KEY (tabpage_id) REFERENCES wwv_mig_olb_olt_tabpage ("ID") ON DELETE CASCADE
) NOCOMPRESS
