CREATE TABLE oc_michael_a.locations (
  ...
  CONSTRAINT loc_c_id_fk FOREIGN KEY (country_id) REFERENCES oc_michael_a.countries (country_id)
);
COMMENT ON TABLE oc_michael_a.locations IS 'Locations table that contains specific address of a specific office,
...
COMMENT ON COLUMN oc_michael_a.locations.postal_code IS 'Postal code of the location of an office, warehouse, or production site
of a company. ';
