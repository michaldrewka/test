CREATE TABLE oc_michael_a.departments (
  ...
  department_name VARCHAR2(31 BYTE) NOT NULL CONSTRAINT dept_name_nn CHECK ("DEPARTMENT_NAME" IS NOT NULL),
  manager_id NUMBER(6),
...
COMMENT ON TABLE oc_michael_a.departments IS 'Departments table that shows details of departments where employees
